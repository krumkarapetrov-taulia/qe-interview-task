describe('Home', () =>{
  ...
  it("should update the welcome message when you enter your names", () => {
    ...
    cy.visit('/');
    cy.get('#root p').should('contain', 'Welcome to the Taulia template app, Jane Doe!')
    ...
    cy.get('#root p').should('contain', 'Welcome to the Taulia template app, Krum Karapetrov!')
  ...
  it("should not allow submitting of the form with an empty required field", function() {
    ...
    cy.get(':nth-child(3) > .tau-field-error').should('contain','Required Field');
